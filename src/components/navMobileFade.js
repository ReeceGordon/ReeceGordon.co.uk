...
const NavMobileFade = (props) => {
    ...
    return(
      <nav css={css`animation: ${fadeIn} 1.2s cubic-bezier(0.390, 0.575, 0.565, 1.000) 3s both;`} sx={{alignSelf: 'flex-end', display: ['flex', 'flex','none', 'none'], flexDirection: 'column', alignItems:'flex-end'}}>
